...
class ConnectionLeakBTraceScript {
	...
	void func(@Self Object obj) {
		...
		for (Map.Entry<Object, Object> entry : managedMap.entrySet()) {
			...
			if (last_checkin_time < checkout_time) {
				...
				BTraceUtils.println(org.apache.commons.lang.exception.ExceptionUtils.getStackTrace(checkoutStackTraceException));
			}
		}
	}
	...
	void func1(@Self Object basicResPool,@Return
			Object connection) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException,
			ClassNotFoundException {
		BTraceUtils.println("settings exception trace");
		@SuppressWarnings("unchecked")
		...
		BTraceUtils.println("settings exception trace done");
	}
}
